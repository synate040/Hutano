"""
Script to implement medication demand forecasting for one hospital.
This script will:
...
def generate_medication_forecast(hospital_id=2):
    ...
    plt.title(f'Medication Demand Forecast for {hospital.name}')
    plt.savefig(os.path.join(forecasts_dir, f"medication_{hospital_id}_forecast.png"), dpi=300, bbox_inches='tight')
    
    # Save components plot
    fig = prophet_model.plot_components(forecast)
    plt.savefig(os.path.join(forecasts_dir, f"medication_{hospital_id}_components.png"), dpi=300, bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    generate_medication_forecast(hospital_id=2)
