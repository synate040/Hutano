...
def create_documentation_figures():
    ...
    patient_data = pd.DataFrame({
        ...
        'admission_date': pd.date_range('2025-01-01', periods=500, freq='D'),
    ...
    staff_data = pd.DataFrame({
        ...
        'shift_date': pd.date_range('2025-01-01', periods=300, freq='D'),
    ...
    prophet_data = pd.DataFrame({
        'ds': pd.date_range('2025-01-01', '2024-12-31', freq='D'),
